...
<div class="chat__msg-day-divider position-relative">
    <span class="chat__msg-day-new-msg position-absolute"><?php echo __('messages.new_keys.new_messages') ?></span>
</div>
...
<div class="d-flex justify-content-center blocked-message-text">
    <span class="chat__msg-day-title"><?php echo __('messages.new_keys.you_have_blocked_this_user') ?></span>
</div>
</script>
...
<div class="">
    ...
    {{/if}}
    {{if urlDetails.image!='' &&  urlDetails.image !=null}}
